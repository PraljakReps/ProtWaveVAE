...
export output_results_path='.././outputs/SH3_task/CV/ProtWaveVAE_SSTrainingHist.csv'
export output_model_path='.././outputs/SH3_task/CV/ProtWaveVAE_SSTrainingHist.pth'
export folder_path='.././outputs/SH3_task/CV'
