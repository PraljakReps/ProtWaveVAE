...
export output_results_path='.././outputs/SH3_task/latent_inference/LatentInference_NaturalHomologs_SSProtWaveVAE.csv'
export output_model_path='.././outputs/SH3_task/final_model/final_ProtWaveVAE_SSTrainingHist.pth'
export save_dir='.././outputs/SH3_task/latent_inference'
