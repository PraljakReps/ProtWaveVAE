...
export output_results_path='.././outputs/benchmark_task/final_model/GB1/final_model_split2.csv'
export output_model_path='.././outputs/benchmark_task/final_model/GB1/final_model_split2.pth'
