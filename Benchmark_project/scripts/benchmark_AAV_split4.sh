...
export output_results_path='.././outputs/benchmark_task/final_model/AAV/final_model_split4.csv'
export output_model_path='.././outputs/benchmark_task/final_model/AAV/final_model_split4.pth'
