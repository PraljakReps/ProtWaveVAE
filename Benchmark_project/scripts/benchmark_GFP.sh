...
# path variables
export data_path='.././data/GFP/GFP_fluorescence'
...
export output_results_path='.././outputs/benchmark_task/final_model/GFP/final_model.csv'
export output_model_path='.././outputs/benchmark_task/final_model/GFP/final_model.pth'
export output_folder_path='.././outputs/benchmark_task/final_model/GFP'
export protein='GFP'
