...
export output_results_path='../../.././outputs/HPoptim/AAV/HPoptim_zdim_2.csv'
export output_model_path='../../.././outputs/HPoptim/AAV/HPoptim_zdim_2.csv'
