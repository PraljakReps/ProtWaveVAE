...
export output_results_path='../../.././outputs/HPoptim/AAV/HPoptim_zdim_3.csv'
export output_model_path='../../.././outputs/HPoptim/AAV/HPoptim_zdim_3.csv'
