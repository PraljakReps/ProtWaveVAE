...
# path variables
export data_path='../../.././data/AAV/full_data.csv' # do not need it
export train_path='../../.././data/'
export valid_path='../../.././data/'
export test_path='../../.././data/'
export output_results_path='../../.././outputs/HPoptim/AAV/AAV_split0_'
export output_model_path='../../.././outputs/HPoptim/AAV/final_model/AAV_split0_zdim.pth'
