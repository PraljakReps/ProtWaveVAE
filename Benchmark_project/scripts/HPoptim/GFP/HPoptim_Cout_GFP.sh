...
export output_results_path='../../.././outputs/HPoptim/GFP/GFP_Cout'
export output_model_path='../../.././outputs/HPoptim/GFP/final_model/GFP_Cout.pth'
...
export C_in=21
export C_out='32,64,128,256,512'
