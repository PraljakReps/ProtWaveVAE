...
export output_results_path='../../.././outputs/HPoptim/stability/stability_zdim0'
export output_model_path='../../.././outputs/HPoptim/stability/final_model/stability_zdim0.pth'
