...
export output_model_path='../../.././outputs/HPoptim/stability/final_model/stability_disc_width.pth'
...
# loss prefactor
export nll_weight='0.1,0.5,1,5,10,50,100'
export MI_weight='0.95'
export lambda_weight='2.0'
export gamma_weight='1.0'

export search_variable='nll_weight'
export n_trials=7
export K=1
