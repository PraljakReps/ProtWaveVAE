...
export output_results_path='../../.././outputs/HPoptim/stability/stability_whs'
export output_model_path='../../.././outputs/HPoptim/stability/final_model/stability_whs.pth'
...
export wave_hidden_state='32,64,128,256,512'
