...
# path variables
export dataset_path='stability.csv' # do not need it
...
export output_results_path='../../.././outputs/HPoptim/stability/stability'
export output_model_path='../../.././outputs/HPoptim/stability/final_model/stability_zdim.pth'
