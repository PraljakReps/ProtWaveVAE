...
export DEVICE='cuda'
export N=100 # number of samples
...
export folder_path='../.././outputs/prediction/Cterminus_design/CM'
export samples_output_path='../.././outputs/prediction/Cterminus_design/CM/CM_sample_sequences_SS.csv'
export Cterminus_output_path='../.././outputs/prediction/Cterminus_design/CM/Cterminus_CM_sample_sequences_SS.csv'
export DeNovo_output_path='../.././outputs/prediction/Cterminus_design/CM/DeNovo_CM_sample_sequences_SS.csv'
...
python ../../diversify_CM.py \
		...
		--N ${N} \
		--Cterminus_output_path ${Cterminus_output_path} \
		--DeNovo_output_path ${DeNovo_output_path} \
