...
export samples_output_path='../.././outputs/prediction/Cterminus_design/CM/CM_sample_sequences_US.csv'
export Cterminus_output_path='../.././outputs/prediction/Cterminus_design/CM/Cterminus_CM_sample_sequences_US.csv'
export DeNovo_output_path='../.././outputs/prediction/Cterminus_design/CM/DeNovo_CM_sample_sequences_US.csv'
