...
export output_results_path='.././outputs/SH3_task/final_ProtWaveVAE_SSTrainingHist.csv'
export output_model_path='.././outputs/SH3_task/final_ProtWaveVAE_SSTrainingHist.pth'
